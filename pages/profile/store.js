      ...
      <div className="py-[12px]">
        <div className="lg:flex justify-between items-center">
          ...
          <div className="flex gap-[16px]">
            <button className="bg-orange-500 text-white min-w-[120px] h-[42px] rounded-[26px] text-[14px]">
              Save
            </button>
            <button className="min-w-[120px] h-[42px] border-orange-500 border-[1px] rounded-[26px] text-orange-500 text-[14px]">
              Clear All
            </button>
          </div>
        </div>
        ...
        <div className="mb-[40px] mt-[20px] flex gap-[16px] flex-wrap">
          {/* <p className="text-[14px] hover:text-orange-500 cursor-pointer">All</p>
           <p className="text-[14px] hover:text-orange-500 cursor-pointer">A</p>
          <p className="text-[14px] hover:text-orange-500 cursor-pointer">B</p>
          <p className="text-[14px] hover:text-orange-500 cursor-pointer">C</p>
          <p className="text-[14px] hover:text-orange-500 cursor-pointer">D</p>
          <p className="text-[14px] hover:text-orange-500 cursor-pointer">E</p>
          <p className="text-[14px] hover:text-orange-500 cursor-pointer">F</p>
          <p className="text-[14px] hover:text-orange-500 cursor-pointer">G</p>
          <p className="text-[14px] hover:text-orange-500 cursor-pointer">H</p>
          <p className="text-[14px] hover:text-orange-500 cursor-pointer">I</p>
          <p className="text-[14px] hover:text-orange-500 cursor-pointer">J</p>
          <p className="text-[14px] hover:text-orange-500 cursor-pointer">K</p>
          <p className="text-[14px] hover:text-orange-500 cursor-pointer">L</p>
          <p className="text-[14px] hover:text-orange-500 cursor-pointer">M</p>
          <p className="text-[14px] hover:text-orange-500 cursor-pointer">N</p>
          <p className="text-[14px] hover:text-orange-500 cursor-pointer">O</p>
          <p className="text-[14px] hover:text-orange-500 cursor-pointer">P</p>
          <p className="text-[14px] hover:text-orange-500 cursor-pointer">Q</p>
          <p className="text-[14px] hover:text-orange-500 cursor-pointer">R</p>
          <p className="text-[14px] hover:text-orange-500 cursor-pointer">S</p>
          <p className="text-[14px] hover:text-orange-500 cursor-pointer">T</p>
          <p className="text-[14px] hover:text-orange-500 cursor-pointer">U</p>
          <p className="text-[14px] hover:text-orange-500 cursor-pointer">V</p>
          <p className="text-[14px] hover:text-orange-500 cursor-pointer">W</p>
          <p className="text-[14px] hover:text-orange-500 cursor-pointer">X</p>
          <p className="text-[14px] hover:text-orange-500 cursor-pointer">Y</p>
          <p className="text-[14px] hover:text-orange-500 cursor-pointer">Z</p> */}
