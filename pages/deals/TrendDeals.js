    ...
    <div className="py-[24px] bg-[#e6edf2]">
      <div className="lg:max-w-[1140px] sm:max-w-[720px] max-w-[540px] mx-auto px-[14px]">
        ...
        <div className="text-center mt-[44px] mb-[24px]">
          <button
            className="border-[1px] hover:border-[#8db654] hover:text-white transition-main hover:bg-[#8db654] border-black bg-transparent max-w-[158px] w-full rounded-[3px] flex justify-center items-center mx-auto text-[14px] h-[42px]"
