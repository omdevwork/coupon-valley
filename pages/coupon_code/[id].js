    ...
    <div>
      ...
      <div className="container max-w-[1096px] m-auto max-xl:max-w-auto max-xl:px-[15px]">
        <div className="relative my-[24px] mx-auto bg-[#fff] mb-[24px] rounded-md py-[36px] px-0 pb-5 text-center  shadow-[0_2px_13px_0_#00000014]">
          <b className="block text-[20px] text-orange-500 relative font-[500]">
            <span className="inline-block w-[32px] h-[32px] bg-orange-500 rounded-[50%] align-middle mr-3 relative top-[-2px] text-center leading-[30px]">
          ...
          <div className="text-orange-500 text-[16px] text-center pt-[15px] hidden">
            Copy & Continue
          </div>
