    ...
    <div className="p-[20px_0]">
      <div className="lg:max-w-[1140px] sm:max-w-[720px] max-w-[540px] mx-auto px-[14px]">
        ...
        <div className="lg:flex items-start gap-[12px] justify-between">
          <div className="border-[#e7e7e7] hover:border-orange-500 rounded-md transition-all border-[1px] shadow-[0_3px_12px_0_rgba(2,3,5,.07)] min-w-[240px] lg:p-[12px] p-[6px_12px] group lg:block flex items-center lg:mb-0 mb-[12px]">
            ...
            />
            <button className="lg:hidden flex bg-orange-500 w-[20px] h-[20px] rounded-full text-white justify-center items-center">
              <BiChevronRight />
            </button>
